---
title: 'Tổng ôn C2: tbào Eukaryote'
description: ''
date: 2024-12-02
tags: ['Sinh Di Truyền']
category: 'Y1'
...
<!-- ## Bài 1. Cấu trúc và chức năng của tbào Eukaryote
...
4. Nhân
5. Chỗ nối của tbào động vật và thực vật
``` -->
...
Các phospholipid khác nhau: đuôi kỵ nước + phần đầu ưa nước ( kích thước, hình dạng và điện tích)
Các thành phần lipid trong màng:
50% khối lượng màng tb ĐV

  Đầu ưa nước (đầu phân cực) +
  Đầu kỵ nước (đầu không phân
  cực). -->
...
2. Sự hình thành tiêu thể và quá trình hoạt động của tiêu thể
Tiêu thể
Thể nội bào muộn
Tiêu thể sơ cấp
...
Hai màng & phức hợp protein lỗ nhân:

* Màng ngoài - tiếp nối với màng của lưới nội sinh chất + ribosome.
* Màng trong: protein đặc biệt → vị trí để chromatin và lá sợi (lamina) nhân bám vào.
(Lá sợi nhân gồm mạng lưới protein lamin của sợi trung gian)

Phức hợp lỗ nhân →lỗ nhân- vận chuyển hai chiều giữa nhân và bào tương:

* Khuếch tán thụ động: <50kD
* Khuếch tán chủ động: >50kD (liên kết với những thụ thể đặc biệt)

* Bào tương → nhân (histone, DNA polymearse, RNA polymerase, protein
điều hoà biểu hiện gen và những protein liên quan đến sự hình thành RNA).

* Nhân → bào tương (tRNA, mRNA).

### Hạch nhân

Vùng tổ chức hạch nhân: gen mã hoá cho các rRNA 5,8S, 18S và 28S (nhánh ngắn của các nhiễm sắc thể tâm đầu 13,14,15, 21 và 22) → tiểu phần ribosome

### Chất nhiễm sắc và nhiễm sắc thể

Chất nhiễm sắc:

* DNA+ protein histone (2H2A, 2H2B, 2H3 và 2H4)
* protein nonhistone :
...
➢ Đặc điểm cấu trúc của chất nhiễm sắc

Chất nhiễm sắc (sợi chromatin) có đường kính 10nm: “sợi gồm vô số các hạt”
=> Sợi chromatin có đường kính 30nm

A- Sợi chromatin 30nm
B- Sợi chromatin: 10nm

▪ Ở giai đoạn gian kỳ:
Vùng nguyên nhiễm sắc – euchromatin (đa số)

* Không có sự đóng xoắn
* DNA x2
* Gen được phiên mã chủ
động
* Khoảng 10% vùng nguyên nhiễm sắc chứa các gen ở trong tình trạng ít đóng xoắn (10nm) được phiên mã.

Vùng dị nhiễm sắc – heterochromatin (10%)

* Đóng xoắn cao
* DNA x2
* Gen được phiên mã một cách bị động
* Chứa các trình tự DNA lặp lại cao - có ở vùng tâm và telomere.

Ở giai đoạn phân chia

* Sợi chromatin (30nm) → vòng chromatin (300nm) nhờ phức protein condensin
...
Thu nhận tb từ mẫu mô (Mô đang phân chia, chứa ít tb đang phân chia)
$\to$ Ức chế hình thành thoi phân bào
$\to$ Phá màng tb
$\to$ Dàn mẫu trên lame
$\to$ Xử lý mẫu bằng protease
$\to$ Nhuộm bằng Giemsa
...
Tế bào cơ và não cần nhiều năng lượng → rối loạn chức năng ti thể → các bệnh về cơ và thần kinh như: bệnh di truyền thần kinh thị giác Leber (LHON), hội chứng co cơ động kinh (MERRF),…

### Tác dụng của thuốc kháng sinh và tác nhân môi trường đối với ti thể

* Kháng sinh ức chế sự tổng hợp protein của ti thể
  * Dùng kháng sinh ít ngày ít gây cho cho ti thể và tế bào
  * Dùng chloramphenicol liều cao & nhiều ngày ức chế tạo hồng cầu và bạch cầu ở tủy xương.
* Tác nhân môi trường ảnh hưởng đến hình thái và sinh lý của ti thể + Khi cơ thể đói → ti thể thay đổi hình dạng → ti thể bị tan rã
  * Trong dung dịch nhược trương → ti thể bị phồng lên
  * Trong dung dịch ưu trương → ti thể bị kéo dài ra
  * Chất độc, chất phóng xạ → thay đổi hoặc phá hủy cấu trúc và
chức năng của ti thể

## Chỗ nối các TB & khoảng ngoài bề mặt của tb

## Bài 2. Protein động cơ và sự vận động của tbào

```markmap
1. Vị trí và chức năng các loại protein động cơ
2. Sự vận động nội tại của tbào
